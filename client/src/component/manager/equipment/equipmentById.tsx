...
const EquipmentManagermentByID = (props: any) => {
    ...
    const fetchData = async () => {
        try {
            ...
            const response = await fetch(`http://localhost:8080/api/v1/equipments?roomid=${roomId}`, {
                method: 'GET',
                headers: {
...
export default EquipmentManagermentByID;